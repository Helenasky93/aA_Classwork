...
ActiveRecord::Base.transaction do
  ...
  # Wizards
  hagrid = User.create!(username: 'Rubeus Hagrid', password: 'walker', age: 45, political_affiliation: "Giant", email: "hagrid@hogwarts.io")
  harry = User.create!(username: 'Harry Potter', password: 'walker', age: 11, political_affiliation: "Gryffindor", email: "harry@hogwarts.io")
  hermione = User.create!(username: 'Hermione Granger', password: 'walker', age: 11, political_affiliation: "Gryffindor", email: "hermione@hogwarts.io")
  ron = User.create!(username: 'Ron Weasley', password: 'walker', age: 11, political_affiliation: "Gryffindor", email: "ron@hogwarts.io")
  dumbledore = User.create!(username: "Albus Dumbledore", password: 'walker', age: 93, political_affiliation: "Headmaster", email: "dumbledore@hogwarts.io")
  draco = User.create!(username: "Draco Malfoy", password: 'walker', age: 11, political_affiliation: "Slytherin", email: "draco@hogwarts.io")
  nimbus = User.create!(username: "Nimbus", password: 'walker', age: 45, email: "brooms@nimbus.io")
  andy = User.create!(username: "Andy", password: 'walker', age: 101, email: "andy@aa.io")
  mike = User.create!(username: "Mike", password: 'walker', age: 5, email: "mike@aa.io")
  ...
  chirp15 = Chirp.create!(author_id: mike.id, body: "Rayzah Blaydes")
  ...
  Like.create!(user_id: hermione.id, chirp_id: chirp1.id)
  ...
  Like.create!(user_id: ron.id, chirp_id: chirp2.id)
